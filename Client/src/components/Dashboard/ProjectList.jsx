  ...
  return (
    <div className="fixed inset-0 bg-app-overlay backdrop-blur-md flex items-center justify-center z-[100] animate-in fade-in duration-200">
      <div className="bg-app-surface border border-app-border p-8 rounded-[3rem] w-[400px] shadow-2xl transform animate-in zoom-in-95 duration-200">
        ...
        <h2 className="text-xl font-bold text-app-text mb-2 text-center">Удалить проект?</h2>
        <p className="text-sm text-app-muted text-center mb-8 px-4 font-medium">Это действие нельзя отменить. Проект исчезнет навсегда.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {projects.map((project) => (
          <div
            ...
            className="group relative bg-app-surface border border-app-border rounded-[3rem] p-7 hover:bg-app-elevated hover:border-app-border-strong transition-all duration-500 cursor-pointer shadow-xl dark:shadow-black/50"
          >
