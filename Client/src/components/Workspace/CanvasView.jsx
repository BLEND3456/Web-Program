...
const CanvasView = React.memo(({ width = 1200, height = 1700, containerRef: externalContainerRef }) => {
  ...
  return (
    <div className="absolute inset-0 bg-app-canvas z-0 pointer-events-none isolate overflow-hidden">
      <div
        ref={containerRef}
        className="absolute inset-0 overflow-auto custom-scrollbar pointer-events-auto overscroll-contain"
      >
